...
const Switch = ({ ref, className, ...props }: ComponentPropsWithoutRef<typeof SwitchPrimitives.Root> & { ref?: React.RefObject<ElementRef<typeof SwitchPrimitives.Root> | null> }) => (
